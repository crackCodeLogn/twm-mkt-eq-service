...
BIN_PATH=$TWM_HOME_PARENT/TWM/$APP_NAME/bin     #PROM-HOME-PARENT :: exported in .bashrc
JAR_PATH=$BIN_PATH/../target/quarkus-app/quarkus-run.jar

APP_PARAMS="-Dequity.holdingsFileLocation=${BIN_PATH}/../landing/holdings.csv -Dequity.executionIntervalDuration=$1"
